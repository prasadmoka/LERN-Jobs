...
class BaseProcessFunctionTestSpec extends BaseSpec with Matchers {
  ...
  "Validation of SerDe" should "validate serialization and deserialization of Map, String and JobRequest schema" in {
  ...
  "Validation of SerDe" should "validate serialization and deserialization of Map, String and Event schema" in {
    ...
    val eventStream =
      env.addSource(kafkaConnector.kafkaEventSource[Event](bsConfig.kafkaEventInputTopic)).name("event-schema-consumer")
